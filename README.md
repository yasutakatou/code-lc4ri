...
In the `example` folder of this repository, we’ve provided samples of deployment procedures for simple Docker and Kubernetes web and database applications using this tool. You can use these to see firsthand **how LC4RI can assist with operational tasks!**<br>
(These samples were generated by Claude Code and converted using Agent Skills)[https://github.com/yasutakatou/markdown-to-lc4ri]. You can adapt existing procedures for AI conversion or use (Agent Skills to convert them)[https://github.com/yasutakatou/markdown-to-lc4ri], allowing you to update your current documentation without having to create new procedures from scratch.<br>
<br>
Markdown:<br>
<img width="155" height="71" alt="image" src="https://github.com/user-attachments/assets/48dfc30a-5438-4935-ac01-e76053c130d3" />
<br>
LC4RI:<br>
<img width="442" height="266" alt="image" src="https://github.com/user-attachments/assets/96827d0c-1616-4357-8349-8ba973aa1a90" />
<br>
(markdown-to-lc4ri Agent Skills)[https://github.com/yasutakatou/markdown-to-lc4ri]
<br>
# Advantages
